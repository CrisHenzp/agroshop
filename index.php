...
<body>
  ...
  <section class="section swiper-container swiper-slider swiper-slider-modern" data-loop="true" data-autoplay="5000"
    ...
    <div class="swiper-wrapper text-left">
      <div class="swiper-slide context-dark" data-slide-bg="Public/images/slider-1-1920x729.jpg">
              ...
              <div class="col-md-10 col-xxl-6">
                <div class="slider-modern-box">
                  <h1 class="slider-modern-title"><span data-caption-animate="slideInDown"
                      data-caption-delay="0">Frutas</span></h1>
                  <p data-caption-animate="fadeInRight" data-caption-delay="400">Agroshop ofrece a los ciudadanos
                    locales y a los huéspedes de nuestra ciudad frutas y otros productos orgánicos de calidad.</p>
                  <div class="oh button-wrap"><a class="button button-primary button-ujarak" href="sobre_nosotros.php"
                      data-caption-animate="slideInLeft" data-caption-delay="400">Leer mas</a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="swiper-slide context-dark" data-slide-bg="Public/images/slider-2-1920x729.jpg">
        <div class="swiper-slide-caption">
          <div class="container">
            <div class="row justify-content-center justify-content-xxl-start">
              <div class="col-md-10 col-xxl-6">
                <div class="slider-modern-box">
                  ...
                  <p data-caption-animate="fadeInRight" data-caption-delay="400">Controlamos el proceso de cultivo en
                    Agroshop para ofrecer los mejores productos orgánicos a nuestros clientes en todo el estado.</p>
                  <div class="oh button-wrap"><a class="button button-primary button-ujarak" href="sobre_nosotros.php"
                      data-caption-animate="slideInLeft" data-caption-delay="400">Leer mas</a></div>
                </div>
              </div>
      ...
      <div class="swiper-slide" data-slide-bg="Public/images/slider-3-1920x729.jpg">
        <div class="swiper-slide-caption">
          <div class="container">
            <div class="row justify-content-center justify-content-xxl-start">
              <div class="col-md-10 col-xxl-6">
                <div class="slider-modern-box">
                  <h1 class="slider-modern-title"><span data-caption-animate="slideInDown"
                      data-caption-delay="0">Cuidamos el medio ambiente</span></h1>
                  <p data-caption-animate="fadeInRight" data-caption-delay="400">Como granja orgánica líder, mantenemos
                    una política ecológica de cultivar y vender alimentos saludables sin aditivos.</p>
                  <div class="oh button-wrap"><a class="button button-primary button-ujarak" href="sobre_nosotros.php"
                      data-caption-animate="slideInUp" data-caption-delay="400">Leer mas</a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-6 col-md-12 col-lg-6">
              <div class="oh-desktop">
                ...
                <article class="product product-2 box-ordered-item wow slideInLeft" data-wow-delay="0s">
                  <div class="unit flex-row flex-lg-column">
                    <div class="unit-left">
                      <div class="product-figure"><img src="Public/images/product-8-270x280.png" alt="" width="270"
                          height="280" />
                        <div class="product-button"><a class="button button-md button-white button-ujarak"
                            href="#">Comprar</a></div>
                      </div>
  ...
  <section class="section text-center">
    <div class="parallax-container" data-parallax-img="Public/images/bg-parallax-1.jpg">
      <div class="parallax-content section-xl section-inset-custom-1 context-dark bg-overlay-40">
        <div class="container">
          <h2 class="oh font-weight-normal"><span class="d-inline-block wow slideInDown" data-wow-delay="0s">Nuestro
              Enfoque</span></h2>
          <p class="oh big text-width-large"><span class="d-inline-block wow slideInUp" data-wow-delay=".2s">Nuestros
              Productores combinan estrictamente las tradiciones de la agricultura orgánica con las últimas innovaciones
              para que nuestros productos sean saludables y seguros para los clientes.</span></p><a
            class="button button-primary button-icon button-icon-left button-ujarak wow fadeInUp"
            href="https://www.youtube.com/watch?v=wDktTysr8rs" data-lightgallery="item" data-wow-delay=".1s"><span
              class="icon mdi mdi-play"></span>Ver Presentacion</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-md bg-default">
    <div class="container">
      <div class="oh">
        <h2 class="wow slideInUp" data-wow-delay="0s">Productores Nacionales</h2>
      </div>
      <div class="row row-30 justify-content-center">
        <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInRight" data-wow-delay="0s">
          ...
          <article class="team-classic"><a class="team-classic-figure" href="#"><img
                src="Public/images/team-1-370x406.jpg" alt="" width="370" height="406" /></a>
            <div class="team-classic-caption">
              <h5 class="team-classic-name"><a href="#">Don Arturo</a></h5>
              <p class="team-classic-status">Comerciante</p>
            </div>
          </article>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInRight" data-wow-delay=".1s">
          <!-- Team Classic-->
          <article class="team-classic"><a class="team-classic-figure" href="#"><img
                src="Public/images/team-2-370x406.jpg" alt="" width="370" height="406" /></a>
            <div class="team-classic-caption">
              <h5 class="team-classic-name"><a href="#">Gustavo becerra</a></h5>
        ...
        <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInRight" data-wow-delay=".2s">
          <!-- Team Classic-->
          <article class="team-classic"><a class="team-classic-figure" href="#"><img
                src="Public/images/team-3-370x406.jpg" alt="" width="370" height="406" /></a>
            <div class="team-classic-caption">
              <h5 class="team-classic-name"><a href="#">Enrique Gonzalez</a></h5>
              <p class="team-classic-status">Comerciante</p>
            </div>
          </article>
        </div>
  ...
  <section class="section">
    <div class="parallax-container" data-parallax-img="Public/images/bg-parallax-2.jpg">
          ...
          <div class="row row-lg row-50 justify-content-center border-classic border-classic-big">
            <div class="col-sm-6 col-md-5 col-lg-3 wow fadeInLeft" data-wow-delay=".1s">
              <div class="counter-creative">
                <div class="counter-creative-number"><span class="counter">100</span>
                </div>
            ...
            <div class="col-sm-6 col-md-5 col-lg-3 wow fadeInLeft" data-wow-delay=".2s">
              <div class="counter-creative">
                <div class="counter-creative-number"><span class="counter">56</span><span
