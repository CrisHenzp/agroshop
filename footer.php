        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
          <div class="oh-desktop">
            <div class="wow slideInRight" data-wow-delay="0s">
              <div class="footer-brand"><a href="index.html"><img src="Public/images/logo-inverse-196x42.png" alt=""
                    width="196" height="42" /></a></div>
              <p>Ofrecemos alimentos y productos saludables a nuestros clientes.</p>
              <ul class="footer-contacts d-inline-block d-md-block">
                <li>
                  <div class="unit unit-spacing-xs">
                    <div class="unit-left"><span class="icon fa fa-phone"></span></div>
                    <div class="unit-body"><a class="link-phone" href="tel:#">+569 57462146</a></div>
                  </div>
                </li>
                <li>
                  <div class="unit unit-spacing-xs">
                    ...
                    <div class="unit-body">
                      <p>Lunes a Viernes: 07:00AM - 08:00PM</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="unit unit-spacing-xs">
                    ...
                    <div class="unit-body"><a class="link-location" href="#">4730 Maipo, Region metropolitana, Santiago
                        8450000</a></div>
                  </div>
                </li>
              </ul>
  ...
  <div class="footer-variant-2-bottom-panel">
    <div class="container">
      ...
      <div class="group-sm group-sm-justify">
        <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>Agroshop</span>. All
          rights reserved
        </p>
        <p class="rights">Design&nbsp;by&nbsp;<a href="#">MaipoGrande</a></p>
      </div>
    </div>
  </div>
</footer>
