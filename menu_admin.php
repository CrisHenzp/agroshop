    ...
    <div class="col-xs-12 col-sm-6 col-md-3 cartas">
        <div class="row center-xs">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-archive" width="100"
                    ...
                    <h5 class="card-title">Administrar Contratos</h5>
                    <p class="card-text">Crear y actualizar contratos de productores</p>
                    <a href="paginas/paghtml.html" class="btn btn-primary">Ir a Contratos</a>
                </div>
            </div>
        ...
        <div class="row center-xs">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <a href="paginas/portafolio.html" class="btn btn-primary">Ir a Pagos</a>
                </div>
            </div>
        </div>
    </div>
